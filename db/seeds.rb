...
subscription_list = [
  ...
  ["Netflix",
    "www.netflix.com",
    "Netflix is a global provider of streaming movies and TV series, and now has over 75 million subscribers.[5] Netflix started as an American DVD-by-mail service in 1998, and began streaming in 2007.[6] Netflix expanded with streaming to Canada in 2010[7] and now serves over 190 countries[8] with streaming. Netflix's first big original series was House of Cards, which debuted in 2013, and Netflix now produces hundreds of hours of original programming around the world",
