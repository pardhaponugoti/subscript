...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewUserForm = __webpack_require__(159);
	var NewSessionForm = __webpack_require__(160);
	
	// New User Form
	
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(NewUserForm, null), document.getElementById('new_user_form'));
	});
	
	// New Session Form
	
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(NewSessionForm, null), document.getElementById('new_session_form'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewSessionForm = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      "form",
	      { action: "/session", method: "post", className: "new-session-form" },
	      React.createElement("input", { name: "authenticity_token", type: "hidden", value: csrfToken }),
	      React.createElement(
	        "label",
	        null,
